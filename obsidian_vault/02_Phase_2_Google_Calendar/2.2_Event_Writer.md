...
## Description
Create the Google Calendar write service. This is the **write-side of the Capture System** — it takes a `ParsedEvent` from the LLM parser and creates the corresponding Google Calendar event.
...
## Implementation Logs
- **Commit:** `2e6c1ff` — feat(calendar): 2.2 Event Writer
- **Files created:**
  - `src/integrations/gcal_service.py` — `add_event()`, `_build_event_body()`, `CalendarError`
