...
## Implementation Logs
- **Commit:** `6ad1ae0` — feat(data): 4.1 Database Setup
- **Files created:**
  - `src/data/models.py` — `Chore` dataclass
  - `src/data/db.py` — `ChoreDB` class with add_chore, get_due_chores, mark_done, list_all, delete_chore
